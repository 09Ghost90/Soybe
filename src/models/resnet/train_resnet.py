...
# Classificação Supervisionada de Imagens de Soja usando ResNet-50
...
epochs_no_improve = 0
learning_rate = 1e-4
PATH = "./models/soybean_model_resnet50.pth"
...
# ResNet-50 usa entrada 224x224 — mais leve que EfficientNet-B7
if device.type == "cpu":
    batch_size = 4
    print("CPU mode: batch_size ajustado para 4 para evitar crash de memória.")
...
# Modelo ResNet-50 pré-treinado
weights = ResNet50_Weights.IMAGENET1K_V2
model = torchvision.models.resnet50(weights=weights)

# ResNet usa model.fc como última camada (diferente do EfficientNet que usa model.classifier)
